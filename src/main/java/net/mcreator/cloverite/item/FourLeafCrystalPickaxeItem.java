...
public class FourLeafCrystalPickaxeItem extends PickaxeItem {
	private static final Tier TOOL_TIER = new Tier() {
		...
		public Ingredient getRepairIngredient() {
			return Ingredient.of(new ItemStack(CloveriteModItems.FOUR_LEAF_CRYSTAL.get()));
		}
	};

	public FourLeafCrystalPickaxeItem() {
